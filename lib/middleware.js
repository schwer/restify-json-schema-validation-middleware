...
const filesFormatter = errorMessageFormatter( 'files' );
...
module.exports = function( config ) {
    ...
    function validateData( schema, data, errorFormatter, next ) {
        ...
        const formattedError = new restifyErrors.BadRequestError( message );
    ...
    middleware.files = function( schema ) {
        return function( req, res, next ) {
            return validateData( schema, req.files, filesFormatter, next );
        };
    };
